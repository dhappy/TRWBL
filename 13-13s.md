...
* Projects
  ...
  * **Substances:** An interface for selling things with a digital testing certificate. Aimed in large part at the violence, dilution, & theft-free distribution of psychotropic substances. (not just psychotropic. broaden scope)
...
* 13 Colors Visualize these with specific rgb
  * Green *(009900)*
  * Blaze *(9D3E3F)*
  * Brown *(663300)*
  * Black *(000000)*
...
* Non-Binary
* if you are gonna go there, you need chromosomes displayed. this is a very technical document to flow from 13's to binaries like black and white and now this. 
* your intention may be pure, but you must display that. otherwise i fear you will fall under heavy scrutiny.
  * _Realm_: ****: ****:
  * _Color_: ****
  * _Language_: ****
  * _Name_: ****
