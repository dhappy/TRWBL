...
The weight goes from -1 ≤ ꞷ ≤ 1, so reactions can be facetious, like a gold medal that has a descriptor "bright"→-0.75.

The target specifies which participants on the call the reaction is aimed toward.